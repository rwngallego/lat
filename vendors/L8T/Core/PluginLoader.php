...
class PluginLoader{
	 ...
	 * @return mixed|multitype: list of classes
	 */
	...
	private function registerKnownMethod($class, $method){
		switch ($method){
			case "beforeRouterDispatch" :
				$this->registeredMethods["beforeRouterDispatch"][] =array($class, $method);
				break;
			case "afterRouterDispatch":
				$this->registeredMethods["afterRouterDispatch"][] = array($class, $method);
				break;
			default:
